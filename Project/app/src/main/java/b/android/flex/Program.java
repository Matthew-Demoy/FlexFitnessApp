...
public class Program {
    ...
    public  Vector<Pair<String , workoutSchedule>> makeFiveByFive(Vector<Pair<String, Integer>> weights)
    {
        ...
        chestWorkout.addExcersise(new exercise("Flat Bench", 3, 10, 1, 2, 2, 59));
        chestWorkout.addExcersise(new exercise("Shoulder Press", 3, 6, 50, 3, 3, 59));
        chestWorkout.addExcersise(new exercise("Lateral Raise", 3, 10, 45, 2, 2, 59));
        ...
        legsWorkout.addExcersise(new exercise("Hamstring Curl", 3, 10, 80, 1, 1, 10));
        legsWorkout.addExcersise(new exercise("Calf Raise", 3, 12, 90, 2, 3, 10));
